...
const HeroSection: React.FC = () => {
  return (
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-32 overflow-hidden bg-gradient-to-b from-jobfix-50/70 to-white">
      {/* Background elements */}
      <div className="absolute inset-0 bg-grid-pattern opacity-[0.4] pointer-events-none"></div>
      <div className="absolute -top-24 -left-24 w-96 h-96 bg-gradient-to-br from-jobfix-100 to-jobfix-200 rounded-full filter blur-3xl opacity-30 animate-float pointer-events-none"></div>
      <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-gradient-to-tr from-jobfix-200 to-jobfix-100 rounded-full filter blur-3xl opacity-30 animate-float pointer-events-none" style={{ animationDelay: '-3s' }}></div>
      
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Column: Text content */}
          <div className="max-w-2xl mx-auto lg:mx-0 text-center lg:text-left fade-in">
            <div className="inline-block px-4 py-1.5 mb-6 rounded-full text-sm font-medium bg-gradient-to-r from-jobfix-100 to-jobfix-200 text-jobfix-700 border border-jobfix-200/50 shadow-sm">
          ...
          <div className={cn(
            ...
            <FadeIn direction="up" delay={0.3}>
              <div className="rounded-2xl overflow-hidden shadow-medium border border-border/50 bg-white p-2 hover-card">
                <div className="relative rounded-xl overflow-hidden aspect-[16/10]">
                  {/* Mockup top bar */}
                  <div className="absolute top-0 inset-x-0 h-8 bg-gradient-to-r from-jobfix-50 to-jobfix-100 flex items-center px-4 rounded-t-lg">
                  ...
                  <div className="pt-8 px-4 pb-4 bg-white h-full">
                    <div className="grid grid-cols-12 gap-4 h-full">
                      {/* Sidebar */}
                      <div className="col-span-3 bg-jobfix-50 rounded-lg p-3">
                      ...
                      <div className="col-span-9 flex flex-col">
                        ...
                        <div className="flex-grow grid grid-cols-2 gap-3">
                          ...
                          <div className="bg-gradient-to-br from-jobfix-50/80 to-white rounded-lg p-3 flex flex-col">
                            <div className="w-1/2 h-4 bg-jobfix-400 rounded-md mb-2 opacity-40"></div>
                            ...
                            <div className="w-1/3 h-5 bg-jobfix-400 rounded-md mt-auto opacity-40"></div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-br from-jobfix-400 to-jobfix-500 rounded-full opacity-20 blur-xl animate-pulse"></div>
            <div className="absolute -top-6 -left-6 w-20 h-20 bg-gradient-to-tr from-jobfix-500 to-jobfix-400 rounded-full opacity-10 blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          </div>
        </div>
      </div>
    </section>
