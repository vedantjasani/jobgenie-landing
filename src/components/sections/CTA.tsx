    ...
    <div className="flex justify-center gap-4 mb-8">
      {[
        ...
        <div key={index} className="flex flex-col items-center">
          <div className="w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-jobfix-800 border border-jobfix-200 dark:border-jobfix-700 rounded-xl flex items-center justify-center shadow-soft">
            <span className="text-2xl md:text-3xl font-mono font-semibold text-jobfix-700 dark:text-jobfix-300">
...
const CTA: React.FC = () => {
  ...
  return (
    <section id="waitlist" className="py-24 md:py-32 bg-gradient-to-b from-jobfix-100 to-white dark:from-jobfix-900 dark:to-jobfix-950 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            <div className="inline-block px-4 py-1.5 mb-6 rounded-full text-sm font-medium bg-jobfix-200 text-jobfix-800 dark:bg-jobfix-800 dark:text-white border border-jobfix-300 dark:border-jobfix-700">
            ...
            <div className="bg-white dark:bg-jobfix-800 rounded-2xl p-6 md:p-8 shadow-medium border border-border/50 dark:border-jobfix-700/30 mb-6">
