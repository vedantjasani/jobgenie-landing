    ...
    >
      <div className="relative flex-grow">
        <Input
          ...
          className="w-full h-12 px-4 placeholder:text-muted-foreground/70 border-2 focus:border-jobfix-300 focus:ring-jobfix-300/20 transition-all duration-200 dark:bg-jobfix-700 dark:border-jobfix-600"
