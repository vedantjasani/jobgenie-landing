...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div className={cn(
      ...
      <div className="mb-5 p-3 w-14 h-14 rounded-xl bg-gradient-to-br from-jobfix-300 to-jobfix-200 dark:from-jobfix-700 dark:to-jobfix-600 flex items-center justify-center text-jobfix-800 dark:text-white shadow-sm">
        <Icon size={24} className="text-jobfix-800 dark:text-white" strokeWidth={2} />
      </div>
      ...
      {/* Hover indicator */}
      <div className="w-0 h-1 bg-gradient-to-r from-jobfix-500 to-jobfix-800 mt-4 transition-all duration-300 group-hover:w-full"></div>
    </div>
  );
};
